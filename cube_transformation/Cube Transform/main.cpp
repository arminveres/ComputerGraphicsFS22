...
vec4f white_color(1.0, 1.0, 1.0, 1.0);
...
int main(int argc, char **argv)
{
  ...
  window = glfwCreateWindow(windowWidth, windowHeight, "Cube Viewer", NULL, NULL);
  if (!window) {
	glfwTerminate();
	return -1;
  } else {
  ...
  glfwSetMouseButtonCallback(window, mouseButtHandler);
